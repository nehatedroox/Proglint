        ...
        <div className={styles.home_subtitle1}>
          <div className={styles.home_about_and_signup_section}>
            <div className={styles.home_about_us_text}>
              ...
              <span>
                TedrooX - Provides Digital Marketing, IT and Business Consulting
                Services. We are a pioneer in Social Media Marketing, Online
                management, UX/UI, Web Design & Application Development with
                Artificial Intelligence/Machine Learning, Augmented Reality &
                Virtual Reality, and Blockchain technologies.
              </span>
            </div>
